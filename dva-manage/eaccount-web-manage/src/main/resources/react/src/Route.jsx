...
const routes = (
    <Route path='/' component={require('./components/Index.jsx')}>
        ...
        <Route path='register' component={require('./components/Register.jsx')}/>
        <Route component={App}>
            ...
            <Route path='sys'>
                ...
                <Route path="work">
                    <IndexRoute component={require('./components/sys/work/View.jsx')}/>
                    <Route path="form" name={formName} component={require('./components/sys/work/Form.jsx')}/>
                    <Route path="detail" name={'工单明细'} component={require('./components/sys/work/detail/View.jsx')}/>
                </Route>
                <Route path="gen">
