        ...
        return (
            <div style={{padding: '40px 20px'}}>
                <Form onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    {
                        record === undefined || (record && record.account && record.account.role && record.account.role.level && record.account.role.level !== 2) ?
                    ...
                    {/* {
                        record && record.account && record.account.role && record.account.role.level && record.account.role.level !== 2 ?
